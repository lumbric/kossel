...
module extruder() {
  rotate([90, 0, 0]) difference() {
    union() {
      ...
      //filament support
      translate([21.75,6.5,34]) rotate([0,0,0]) cylinder (h=8, r=3, $fn=50);
    ...
    translate([16,21,21]) rotate([90,0,0]){
      ...
      rotate([0,0,45]) {
        //translate([14,0,0]) cylinder(h=22, r=1.6, $fn=50);
        translate([0,14,0]) cylinder(h=22, r=1.6, $fn=50);
        translate([-14,0,0]) cylinder(h=22, r=1.6, $fn=50);
        translate([0,-14,0]) cylinder(h=22, r=1.6, $fn=50);
      }
    }
    ...
    //bearing screws
    translate([31,21,21]) rotate([90,0,0]) cylinder (h=22, r=2.6, $fn=50);
    ...
    translate([15,12,38]) rotate([0,90,0])
      cylinder(h=20, r=m3_wide_radius, $fn=50);
  }
}
